...
admin_urls = [
    re_path(r'^repositories/add', admin_views.add_repository,
            name='core_federated_search_app_repositories_add'),
    re_path(r'^repositories/delete', admin_ajax.delete_repository,
            name='core_federated_search_app_repositories_delete'),
    re_path(r'^repositories/(?P<pk>[\w-]+)/edit/$', admin_ajax.EditRepositoryView.as_view(),
            name='core_federated_search_app_repositories_edit'),
    re_path(r'^repositories/refresh', admin_ajax.refresh_repository,
            name='core_federated_search_app_repositories_refresh'),
    re_path(r'^repositories', admin_views.manage_repositories,
