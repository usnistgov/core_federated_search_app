...
urlpatterns = [
    re_path(r'^instance/$', instance_views.InstanceList.as_view(),
            name='core_federated_search_app_rest_instance'),

    re_path(r'^instance/(?P<pk>\w+)/$', instance_views.InstanceDetail.as_view(),
            name='core_federated_search_app_rest_instance_detail'),

    re_path(r'^instance/(?P<pk>\w+)/refresh/$', instance_views.InstanceRefreshToken.as_view(),
