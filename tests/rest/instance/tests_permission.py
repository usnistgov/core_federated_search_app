...
from core_federated_search_app.rest.instance.serializers import InstanceSerializerModel, InstanceSerializerCreate
...
class TestInstanceListGetPermission(SimpleTestCase):
    ...
    def test_is_staff_returns_http_200(self, instance_serializer_data, instance_get_all):
...
class TestInstanceListPostPermission(SimpleTestCase):
    ...
    def test_is_staff_returns_http_201(self,
...
class TestInstanceDetailPatchPermission(SimpleTestCase):
    ...
    @patch.object(InstanceSerializerModel, "data")
    def test_is_staff_returns_http_200(self,
                                       instance_serializer_data,
                                       instance_serializer_save,
                                       instance_serializer_is_valid,
                                       instance_get_by_id):
...
class TestInstanceDetailDeletePermission(SimpleTestCase):
        ...
        @patch.object(Instance, "get_by_id")
        def test_is_staff_returns_http_204(self,
                                           instance_get_by_id,
                                           instance_delete):
            instance_get_by_id.return_value = Instance("mock",
                                                   "http://mock.com/",
                                                   "mock",
                                                   "mock",
